...
namespace PutridParrot.Windows
{
    ...
    public interface IShellLinkW
    {
        ...
        void GetPath([Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder pszFile, int cchMaxPath,
            out Shell.WIN32_FIND_DATAW pfd, Shell.SLGP_FLAGS fFlags);
        ...
        /// <summary>
        /// Sets the show command for a Shell link object. The show 
        ...
        /// <summary>
        /// Sets the location (path and index) of the icon for 
        /// a Shell link object
        /// </summary>
        ...
        /// </summary>
        void Resolve(IntPtr hwnd, Shell.SLR_FLAGS fFlags);
